...
import ProfileSubscription from '../profile/ProfileSubscription.vue'
import ProfileArticles from '../profile/ProfileArticles.vue'
...
<template>
  <div>
    ...
    <ProfileArticles />
    <PaginationComponent
      :items="user.user.articles.last_page"
      purpose="profile"
    />
    <ProfileSubscription />
  </div>
